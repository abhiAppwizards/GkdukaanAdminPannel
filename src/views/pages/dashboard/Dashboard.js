                  ...
                  >
                    ...
                    <td className="text-center">
                      <div className="flex justify-center items-center rtl:space-x-reverse">
                        <span
                          className={`inline-block px-3 text-center py-1.5 rounded ${
                            product.in_stock ? 'bg-green-600' : 'bg-red-600'
                          } text-xs whitespace-nowrap relative font-medium text-dark bg-accent bg-opacity-10 text-accent capitalize`}
                        >
              ...
              <tbody>
                {data?.topVendors?.map((vendor) => (
                  ...
                  >
                    ...
                    <td className="px-6 py-4 text-center">
                      {vendor?.approved === true ? 'Approved' : 'Rejected'}
                    </td>
                    <td className="text-center">
                      <div className="flex justify-center items-center rtl:space-x-reverse">
                        <span
                          className={`inline-block px-3 text-center py-1.5 rounded ${
                            vendor?.account_status == 'active' ? 'bg-green-400' : 'bg-red-600'
                          } text-xs whitespace-nowrap relative font-medium text-dark bg-accent bg-opacity-10 !text-accent capitalize`}
                        >
