...
const VendorPayment = ({}) => {
  ...
  const [editingId, setEditingId] = useState('009'); 
  ...
  return (
    <div className="">
      ...
      <div className="mb-8 rounded-lg bg-white bg-light -3 md:p-8">
        <h1 className="font-bold text-xl mb-4"> Your All VendorPayment:-</h1>
            ...
            <tbody>
              {currentProducts.map((product) => (
                ...
                >
                  ...
                  <td className="text-center">
                    <div  className="flex justify-center items-center rtl:space-x-reverse">
                      <button onClick={handlePaid} className="inline-block px-3 text-center py-1.5 rounded bg-green-500 text-xs whitespace-nowrap relative font-medium text-dark bg-accent bg-opacity-10 !text-accent capitalize">
                        Mark as paid
                      </button>
                    </div>
                  </td>
